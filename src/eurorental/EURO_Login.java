 ...
 */
public class EURO_Login extends javax.swing.JFrame {

    /**
     * Creates new form EURO_Login
     */
    public EURO_Login() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        registerUser.setFont(new java.awt.Font("Century Schoolbook", 0, 18)); // NOI18N
        registerUser.setForeground(new java.awt.Color(255, 255, 255));
        registerUser.setText("Register");
        registerUser.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 343, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(112, 112, 112)
                .addComponent(registerUser, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try{
            ...
            if("adminuser".equals(username) && "adminpassword".equals(password)){
                    EURO_AdmMenu adminDashboard = new EURO_AdmMenu();
            ...
            for(int i = 0; i<Data.customerData.size();i++){
                if(Data.customerData.get(i).getUsername().equals(username) && Data.customerData.get(i).getPassword().equals(password)){
                    EURO_CustMenu dashboard = new EURO_CustMenu();
                    JOptionPane.showMessageDialog(null,"Login Successful");
                    Data.currentLogin.add(Data.customerData.get(i).getName());
    ...
    private void registerUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registerUserMouseClicked
        // TODO add your handling code here:
        EURO_Register regis = new EURO_Register();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EURO_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Data.read();
                new EURO_Login().setVisible(true);
            }
        });
    }
