 ...
 */
public class EURO_EditCustomer extends javax.swing.JFrame {

    /**
     * Creates new form EURO_EditCustomer
     */
    public EURO_EditCustomer() {
        initComponents();
        view();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Modify Customer");
        ...
        editCustomer.setBackground(new java.awt.Color(204, 204, 204));
        editCustomer.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        editCustomer.setText("Update Customer");
        ...
        usernameField.setFont(new java.awt.Font("Century Gothic", 2, 14)); // NOI18N
        usernameField.setText("BRAND");

        nameField.setFont(new java.awt.Font("Century Gothic", 2, 14)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(locationField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(editCustomer, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
    ...
    private void custListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_custListMouseClicked
        ...
        usernameField.setText(custList.getValueAt(number, 0).toString());
        passwordField.setText(custList.getValueAt(number,1).toString());
        nameField.setText(custList.getValueAt(number, 2).toString());
        phoneField.setText(custList.getValueAt(number, 3).toString());
        locationField.setText(custList.getValueAt(number,4).toString());
        // TODO add your handling code here:
    ...
    private void editCustomerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editCustomerMouseClicked
        ...
        Customer modifCust = new Customer(username,password,name,phoneNumber,location);
        Data.customerData.set(number, modifCust);
        Data.write();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EURO_EditCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Data.read();
                new EURO_EditCustomer().setVisible(true);
            }
        });
    }
